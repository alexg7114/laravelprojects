...
<head>
    ...
    <!-- Custom styles for this template -->
    <link href="welcome1.css" rel="stylesheet">
</head>
<body>
...
<main class="container">
    <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
        <div class="col-md-6 px-0">
            <h1 class="display-4 fst-italic">Welcome to the our news site! We are introducing the most important news today</h1>
            <p class="lead my-3">What’s most interesting in this site.</p>
